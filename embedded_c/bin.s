...
0000000000001169 <main>:
    ...
    1184:	c7 45 e4 0a 00 00 00 	movl   $0xa,-0x1c(%rbp)
    118b:	c7 45 e8 14 00 00 00 	movl   $0x14,-0x18(%rbp)
    1192:	48 8d 55 e4          	lea    -0x1c(%rbp),%rdx
    1196:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    ...
    11ae:	48 8d 45 e4          	lea    -0x1c(%rbp),%rax
    11b2:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11b6:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11ba:	48 83 c0 04          	add    $0x4,%rax
    11be:	c7 00 1e 00 00 00    	movl   $0x1e,(%rax)
    11c4:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11c7:	89 45 ec             	mov    %eax,-0x14(%rbp)
    11ca:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11cd:	89 c6                	mov    %eax,%esi
    11cf:	48 8d 3d 49 0e 00 00 	lea    0xe49(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11d6:	b8 00 00 00 00       	mov    $0x0,%eax
    11db:	e8 90 fe ff ff       	callq  1070 <printf@plt>
    11e0:	b8 00 00 00 00       	mov    $0x0,%eax
    11e5:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11e9:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    11f0:	00 00 
    11f2:	74 05                	je     11f9 <main+0x90>
    11f4:	e8 67 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11f9:	c9                   	leaveq 
    11fa:	c3                   	retq   
