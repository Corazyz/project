...
if __name__ == '__main__':
    data_dir = 'D:/images/'
    file_list = glob.glob('/home/zyz/projects/python_projects/GMM_project/frame/*.bmp')
    i = -1
    for file in file_list:
        # print(file)
        i += 1
        ...
        cv2.imwrite("/home/zyz/projects/python_projects/GMM_project/gray/{}.jpg".format(i), m_mask)
        t2 = time.time()
        print(t2-t1)