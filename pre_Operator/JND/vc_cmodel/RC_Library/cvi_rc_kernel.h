...
#define  FLOAT_VAL_p6 ( 0x3f19999a )
...
#define  FLOAT_VAL_14p2122 ( 0x4163652c )
#else
...
typedef struct _stRcKernelInfo_ {
  ...
  int lastPicQpClip;
  int picQpNormalClip;
  stRLModel rqModel[MAX_T_LAYER]; // 0: I frame, 1: temporal base layer, 2: temporal sencond layer, 2: temporal third layer
  RC_Float alphaStep;
  RC_Float betaStep;
