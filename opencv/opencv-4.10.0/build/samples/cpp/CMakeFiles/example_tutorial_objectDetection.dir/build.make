...
samples/cpp/CMakeFiles/example_tutorial_objectDetection.dir/tutorial_code/objectDetection/objectDetection.cpp.o: ../samples/cpp/tutorial_code/objectDetection/objectDetection.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/zyz/projects/opencv/opencv-4.10.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object samples/cpp/CMakeFiles/example_tutorial_objectDetection.dir/tutorial_code/objectDetection/objectDetection.cpp.o"
	cd /home/zyz/projects/opencv/opencv-4.10.0/build/samples/cpp && /usr/bin/ccache /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_tutorial_objectDetection.dir/tutorial_code/objectDetection/objectDetection.cpp.o -c /home/zyz/projects/opencv/opencv-4.10.0/samples/cpp/tutorial_code/objectDetection/objectDetection.cpp
...
bin/example_tutorial_objectDetection: lib/libopencv_gapi.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_highgui.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_ml.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_objdetect.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_photo.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_stitching.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_video.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_videoio.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_imgcodecs.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_calib3d.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_features2d.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_flann.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_dnn.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_imgproc.so.4.10.0
bin/example_tutorial_objectDetection: lib/libopencv_core.so.4.10.0
bin/example_tutorial_objectDetection: samples/cpp/CMakeFiles/example_tutorial_objectDetection.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/zyz/projects/opencv/opencv-4.10.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tutorial_objectDetection"
	cd /home/zyz/projects/opencv/opencv-4.10.0/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tutorial_objectDetection.dir/link.txt --verbose=$(VERBOSE)
...
samples/cpp/CMakeFiles/example_tutorial_objectDetection.dir/clean:
	cd /home/zyz/projects/opencv/opencv-4.10.0/build/samples/cpp && $(CMAKE_COMMAND) -P CMakeFiles/example_tutorial_objectDetection.dir/cmake_clean.cmake
